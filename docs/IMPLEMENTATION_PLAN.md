...
| ID | 需求名称 | 优先级 | 状态 | 预计工时 |
|----|----------|--------|------|----------|
| R1 | 历史告警持久化（SQLite） | P0 | ⬜ 待开始 | 1天 |
| R2 | 历史告警不显示修复 | P0 | ⬜ 待开始 | 0.5天 |
| R3 | 历史告警查看录波和回放 | P0 | ⬜ 待开始 | 1天 |
| R4 | 告警/录波界面显示当前模式 | P1 | ⬜ 待开始 | 0.5天 |
| R5 | 远程模式告警管理 | P1 | ⬜ 待开始 | 2天 |
| R6 | 远程模式录波（本地录波远程数据） | P1 | ⬜ 待开始 | 1.5天 |
| R7 | 通道类型区分（采集/服务） | P2 | ⬜ 待开始 | 2天 |
| R8 | 全局数据模型（GlobalDataModel） | P2 | ⬜ 待开始 | 2天 |
| R9 | 系统变量管理器 | P2 | ⬜ 待开始 | 2天 |
| R10 | 批量创建通道功能 | P2 | ⬜ 待开始 | 2天 |
